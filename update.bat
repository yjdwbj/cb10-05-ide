...
set MPATH="C:\\Program Files\\CodeBlocks-10.05\\MinGW\\bin"
...
%MPATH%\strip output\*.exe
%MPATH%\strip output\*.dll
%MPATH%\strip %CB_OUTPUT_RESDIR%\plugins\*.dll
xcopy /D /y ChangesLog.txt output > nul
