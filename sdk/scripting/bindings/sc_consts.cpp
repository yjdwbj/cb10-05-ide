 ...
 *
 * $Revision: 6122 $
 * $Id: sc_consts.cpp 6122 2010-01-31 03:49:25Z biplab $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/sdk/scripting/bindings/sc_consts.cpp $
 */
...
namespace ScriptBindings
{
    ...
    void Register_Constants()
    {
        ...
        BIND_INT_CONSTANT(ttOr32);
        BIND_INT_CONSTANT(ttCld);
        ...
        BIND_WXSTR_CONSTANT_NAMED(FileFilters::DSP563_EXT, "EXT_CLD");
        ...
        BIND_WXSTR_CONSTANT_NAMED(FileFilters::OR32_EXT, "EXT_OR32");
        ...
        BIND_WXSTR_CONSTANT_NAMED(FileFilters::DSP563_DOT_EXT, "DOT_EXT_CLD");
        BIND_WXSTR_CONSTANT_NAMED(FileFilters::CTL_DOT_EXT, "DOT_EXT_CTL");
//        BIND_WXSTR_CONSTANT_NAMED(FileFilters::CLN_DOT_EXT, "DOT_EXT_CLN");
        ...
        BIND_WXSTR_CONSTANT_NAMED(FileFilters::OR32_DOT_EXT, "DOT_EXT_OR32");
