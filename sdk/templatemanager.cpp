 ...
 *
 * $Revision: 5549 $
 * $Id: templatemanager.cpp 5549 2009-04-27 16:08:11Z biplab $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/sdk/templatemanager.cpp $
 */
...
{
    cbProject* prj = NULL;   // lcy Create Template
            ...
            if(prj && !newname.IsEmpty())
            {
                ...
                for (int i = 0; i < prj->GetBuildTargetsCount(); ++i)
                {
                    ...
                    if (tgfpPrefix == tgfpPlatformDefault && bt->GetTargetType() == ttStaticLib)
                    {
                        ...
                        // CompilerOptions copt = projectCompiler->GetOptions();
                        //projectCompiler->SetOptions("-Os");
