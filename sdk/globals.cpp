 ...
 *
 * $Revision: 5993 $
 * $Id: globals.cpp 5993 2009-12-31 14:47:51Z mortenmacfly $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/sdk/globals.cpp $
 */
...
//        return ftMSVC7Workspace;
    ...
    else if (ext.IsSameAs(FileFilters::DSP563_EXT))
        return ftDsp5xx;
    else if (ext.IsSameAs(FileFilters::OR32_EXT))
        return ftOr32;
//    else if (ext.IsSameAs(FileFilters::LD_EXT))
//        return ftLd;
