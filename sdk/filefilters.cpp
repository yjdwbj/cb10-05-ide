...
void FileFilters::AddDefaultFileFilters()
{
    if (s_Filters.size() != 0)
        return;
    Add(_("MC::Tools workspace files"),         _T("*.workspace"));
    Add(_("MC::Tools project files"),           _T("*.cbp"));
...
const wxString FileFilters::DSP563_EXT                   = _T("cld");
const wxString FileFilters::CTL_EXT                    = _T("ctl");
//const wxString FileFilters::CLN_EXT                    = _T("cln");
...
const wxString FileFilters::OR32_EXT                     = _T("or32");
const wxString FileFilters::LD_EXT                       = _T("ld");
...
const wxString FileFilters::DSP563_DOT_EXT                   = _T('.') + FileFilters::DSP563_EXT;
const wxString FileFilters::CTL_DOT_EXT                   = _T('.') + FileFilters::CTL_EXT;
//const wxString FileFilters::CLN_DOT_EXT                   = _T('.') + FileFilters::CLN_EXT;
...
const wxString FileFilters::OR32_DOT_EXT                     = _T('.') + FileFilters::OR32_EXT;
const wxString FileFilters::LD_DOT_EXT                       = _T('.') + FileFilters::LD_EXT;
