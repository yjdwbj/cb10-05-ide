 ...
 *
 * $Revision: 5480 $
 * $Id: compiletargetbase.cpp 5480 2009-03-04 10:38:26Z mortenmacfly $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/sdk/compiletargetbase.cpp $
 */
...
void CompileTargetBase::GenerateTargetFilename(wxString& filename) const
{
    ...
    case ttExecutable:
    {
        if (m_ExtensionGenerationPolicy == tgfpPlatformDefault)
        {
            ...
            {
                filename << FileFilters::OR32_DOT_EXT;
            }
            else
