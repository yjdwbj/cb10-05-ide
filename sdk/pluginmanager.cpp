 ...
 *
 * $Revision: 6118 $
 * $Id: pluginmanager.cpp 6118 2010-01-29 22:15:27Z mandrav $
...
//            Manager::Get()->GetLogManager()->DebugLog(F(_T("Plugin file removed")));
        ...
        else
        {
            ...
            cbMessageBox(_("Plugin could not be completely uninstalled because its files could not be removed.\n\n"
                            ...
                            "(manually) when you shut down MC::Tools.\n"
...
//    Manager::Get()->GetLogManager()->DebugLog(F(_T("Creating archive: ") + filename));
    ...
    zip.SetComment(_T("This is a redistributable plugin for the MC::Tools IDE.\n"
...
int PluginManager::ScanForPlugins(const wxString& path)
{
    ...
    if (!failed.IsEmpty())
    {
        InfoWindow::Display(_("Warning"),
                            ...
                            "a different version of the MC::Tools SDK.\n"
...
void PluginManager::LoadAllPlugins()
{
    ...
    {
        wxString msg;
        msg.Printf(_("Plugin \"%s\" failed to load last time MC::Tools was executed.\n"
