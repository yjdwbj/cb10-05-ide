 ...
 *
 * $Revision: 6104 $
 * $Id: pluginsconfigurationdlg.cpp 6104 2010-01-23 12:56:12Z mortenmacfly $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/sdk/pluginsconfigurationdlg.cpp $
 */
...
PluginsConfigurationDlg::PluginsConfigurationDlg(wxWindow* parent)
{
    ...
    initialInfo << _("If a plugin is not well-written, it could cause MC::Tools to crash ");
	...
	if (PluginManager::GetSafeMode())
	{
		...
		initialInfo << _("MC::Tools started up in \"safe-mode\"");
		initialInfo << _T("</font></b><br /><i><font color=\"black\">\n");
...
void PluginsConfigurationDlg::OnInstall(wxCommandEvent& event)
{
    wxFileDialog fd(this,
                        ...
                        _T("MC::Tools Plugins (*.cbplugin)|*.cbplugin"),
