 ...
 *
 * $Revision: 5739 $
 * $Id: logmanager.cpp 5739 2009-08-24 07:24:56Z mortenmacfly $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/sdk/logmanager.cpp $
 */
...
LogManager::LogManager()
{
    ...
    slot[app_log].title = _T("MC::Tools");
    slot[debug_log].title = _T("MC::Tools Debug");
