...
// Set the vertical scrollbar to use instead of the on that's built-in.
...
{
    SCNotification& scn = *_scn;    // lcy 文本编辑框上的双击事件
    ...
    GetEventHandler()->ProcessEvent(evt);   /// lcy ProcessEvent
}
