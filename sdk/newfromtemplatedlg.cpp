 ...
 *
 * $Revision: 6104 $
 * $Id: newfromtemplatedlg.cpp 6104 2010-01-23 12:56:12Z mortenmacfly $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/sdk/newfromtemplatedlg.cpp $
 */
...
void NewFromTemplateDlg::OnEditGlobalScript(wxCommandEvent& event)
{
    cbMessageBox(_("Any changes you make to the global wizard registration script will "
                    "take effect after you restart MC::Tools."),
...
void NewFromTemplateDlg::OnHelp(wxCommandEvent& event)
{
    cbMessageBox(_("When you edit a wizard's script, you actually edit a copy of it which "
                    ...
                    "This means that if a new version of the script is released, MC::Tools "
                    ...
                    "So, if you update your MC::Tools copy and find that an updated wizard's "
