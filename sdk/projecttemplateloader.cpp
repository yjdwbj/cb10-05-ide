 ...
 *
 * $Revision: 4909 $
 * $Id: projecttemplateloader.cpp 4909 2008-02-27 13:15:26Z mortenmacfly $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/sdk/projecttemplateloader.cpp $
 */
...
//    pMsg->DebugLog(_T("Reading template file %s"), filename.c_str());
    ...
    if (!root)
    {
        ...
        if (!root)
        {
            pMsg->DebugLog(_T("Not a valid MC::Tools template file..."));
            return false;
        }
    }
