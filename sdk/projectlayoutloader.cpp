 ...
 *
 * $Revision: 5739 $
 * $Id: projectlayoutloader.cpp 5739 2009-08-24 07:24:56Z mortenmacfly $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/sdk/projectlayoutloader.cpp $
 */
...
bool ProjectLayoutLoader::Open(const wxString& filename)
{
    ...
    if (!root)
    {
        ...
        if (!root)
        {
            pMsg->DebugLog(_T("Not a valid MC::Tools layout file..."));
            return false;
        }
    }
