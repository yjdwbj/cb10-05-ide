 ...
 *
 * $Revision: 6104 $
 * $Id: uservarmanager.cpp 6104 2010-01-23 12:56:12Z mortenmacfly $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/sdk/uservarmanager.cpp $
 */
...
wxString UserVariableManager::Replace(const wxString& variable)
{
    ...
    if(base.IsEmpty())
    {
        ...
        {
            wxString msg;
            msg.Printf(_("In the currently active Set, MC::Tools does not know\nthe global compiler variable \"%s\".\n\nPlease define it."), package.c_str());
