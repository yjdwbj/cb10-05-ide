 ...
 *
 * $Revision: 6104 $
 * $Id: advancedcompileroptionsdlg.cpp 6104 2010-01-23 12:56:12Z mortenmacfly $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/plugins/compilergcc/advancedcompileroptionsdlg.cpp $
 */
...
void AdvancedCompilerOptionsDlg::ReadCompilerOptions()
{
    ...
    wxString cur = prj->GetActiveBuildTarget();

    ProjectBuildTarget *target = prj->GetBuildTarget(cur);
    // switches
...
//    XRCCTRL(*this, "chkUseFullSourcePaths", wxCheckBox)->SetValue(switches.UseFullSourcePaths);
    ...
    XRCCTRL(*this, "chkUseFlatObjects", wxCheckBox)->SetValue(target->GetUseFlatObjects());
    XRCCTRL(*this, "chkUseFullSourcePaths", wxCheckBox)->SetValue(target->GetUseFullSourcePaths());
...
void AdvancedCompilerOptionsDlg::WriteCompilerOptions()
{
    ...
    target->SetUseFlatObjects(XRCCTRL(*this, "chkUseFlatObjects", wxCheckBox)->GetValue());
    target->SetUseFullSourcePaths(XRCCTRL(*this, "chkUseFullSourcePaths", wxCheckBox)->GetValue());
    target->CompareMirror();
