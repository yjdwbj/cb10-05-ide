...
//        void OnCreateDist(wxCommandEvent& event);
        ...
        void DowloadFlash();
        void AddLitBatCmd(const wxString& cmd) {m_Lits.Add(cmd);}
        time_t GetRamLDTimestamp() const  {return m_RamLD;}
        void SetRamLDTimestamp(time_t newtime)   { m_RamLD = newtime;}
    private:
        ...
        PipedProcess* pDownload ;
        wxInputStream *StreamOut;
