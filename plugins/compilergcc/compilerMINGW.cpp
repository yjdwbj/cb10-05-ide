 ...
 *
 * $Revision: 6067 $
 * $Id: compilerMINGW.cpp 6067 2010-01-10 15:56:19Z biplab $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/plugins/compilergcc/compilerMINGW.cpp $
 */
...
AutoDetectResult CompilerMINGW::AutoDetectInstallationDir()
{
    ...
    if (platform::windows)
    {
        // look first if MinGW was installed with MC::Tools (new in beta6)
