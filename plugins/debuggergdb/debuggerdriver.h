...
class DebuggerDriver
{
    public:
       ...
       // virtual void TestTcpPort = 0;

        virtual void Continue() = 0;
        virtual void Step() = 0;
        virtual void JtagStall() = 0;
        virtual void StepInstruction() = 0;
        virtual void StepIn() = 0;
        virtual void StepOut() = 0;
        virtual void Backtrace() = 0;
        virtual void Disassemble() = 0;
        virtual void StepByStepDisas() = 0;
        virtual bool TestJtagTcp() = 0;
      //  virtual void GdbCmd_Disassembly(DebuggerDriver* driver, DisassemblyDlg* dlg)=0;
        ...
        virtual wxString GetTargetID() =0;
