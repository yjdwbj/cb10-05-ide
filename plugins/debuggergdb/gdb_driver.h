...
class GDB_driver : public DebuggerDriver
{
    public:
        ...
        virtual void Stop();
        virtual void MCStop();
       // virtual BOOL TestTcpPort();
        virtual void Continue();
        virtual void Step();
        virtual void JtagStall();
        virtual void StepInstruction();
        virtual void StepIn();
        virtual void PrintPC();
        virtual void StepOut();
        virtual void Backtrace();
        virtual void Disassemble();
        virtual void StepByStepDisas();
        virtual bool TestJtagTcp();
        virtual void CPURegisters();
//        virtual void GdbCmd_Disassembly(DebuggerDriver* driver, DisassemblyDlg* dlg);
        ...
        virtual wxString  GetTargetID() { return m_pTarget->GetCompilerID();}
        virtual unsigned long  GetCurrentPC() { return m_CurrentPc;}
