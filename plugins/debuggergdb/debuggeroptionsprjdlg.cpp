 ...
 *
 * $Revision: 5931 $
 * $Id: debuggeroptionsprjdlg.cpp 5931 2009-11-21 15:58:42Z biplab $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/plugins/debuggergdb/debuggeroptionsprjdlg.cpp $
 */
...
void DebuggerOptionsProjectDlg::LoadCurrentRemoteDebuggingRecord()
{
    ...
    m_LastTargetSel = XRCCTRL(*this, "lstTargets", wxListBox)->GetSelection() - 2;
    ...
    if (m_CurrentRemoteDebugging.find(bt) != m_CurrentRemoteDebugging.end())
    {
        ...
        XRCCTRL(*this, "txtIP", wxTextCtrl)->SetValue(_("127.0.0.1"));
    ...
    else
    {
        ...
        XRCCTRL(*this, "txtIP", wxTextCtrl)->SetValue(_("127.0.0.1"));
        XRCCTRL(*this, "txtPort", wxTextCtrl)->SetValue(_("9999"));
