 ...
 *
 * $Revision: 5018 $
 * $Id: cdb_driver.cpp 5018 2008-04-24 10:54:15Z mandrav $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/plugins/debuggergdb/cdb_driver.cpp $
 */
...
wxString CDB_driver::GetCommandLine(const wxString& debugger, const wxString& debuggee)
{
    wxString cmd;
    cmd << debugger;
    cmd << _T(" -g"); // ignore starting breakpoint lcy -g
