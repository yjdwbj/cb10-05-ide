...
/** @brief Represents a MC::Tools project.
  *
...
class DLLIMPORT cbProject : public CompileTargetBase
{
     public:
        ...
        wxArrayString GetLastOpenFiles() const {return m_FileByGroup;}
    ...
    private:
        ...
        wxTreeItemId m_TreeRootByGroup;
