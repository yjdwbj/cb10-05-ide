...
/** @brief A file editor
  *
  * This class represents one builtin editor in MC::Tools. It holds all the necessary
  * information about an editor. When you want to access a MC::Tools editor,
...
class DLLIMPORT cbEditor : public EditorBase
{
    ...
    public:
        ...
        void StepByStepOnDebug(bool notifyDebugger = true);
        ...
        void SetFirstVisibleLineA(int line);
