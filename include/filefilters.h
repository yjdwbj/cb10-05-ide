...
namespace FileFilters
{
    ...
    extern const DLLIMPORT wxString DSP563_EXT;
    extern const DLLIMPORT wxString CTL_EXT;   // 2012-8-27 lcy
//    extern const DLLIMPORT wxString CLN_EXT;
    ...
    extern const DLLIMPORT wxString OR32_EXT;
    extern const DLLIMPORT wxString LD_EXT;
    ...
    extern const DLLIMPORT wxString EXECUTABLE_EXT; // lcy
    ...
    extern const DLLIMPORT wxString DSP563_DOT_EXT;
    extern const DLLIMPORT wxString CTL_DOT_EXT;
//    extern const DLLIMPORT wxString CLN_DOT_EXT;
    ...
    extern const DLLIMPORT wxString OR32_DOT_EXT;
    extern const DLLIMPORT wxString LD_DOT_EXT;
