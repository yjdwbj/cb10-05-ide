...
enum SearchDirs
{
    ...
    sdBase            = 0x0002, ///< MC::Tools' installation base
...
public:
    ...
    *
    * You should always use this function if you are looking for "some arbitrary file that belongs to MC::Tools",
    ...
    */
    ...
    /** @brief Access one of MC::Tools' folders.
