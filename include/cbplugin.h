...
class PLUGIN_EXPORT cbPlugin : public wxEvtHandler
{
    public:
		...
		/** This method is called by MC::Tools and is used by the plugin
		  * to add any menu items it needs on MC::Tools's menu bar.\n
		...
		/** This method is called by MC::Tools core modules (EditorManager,
		...
		/** This method is called by MC::Tools and is used by the plugin
		  * to add any toolbar items it needs on MC::Tools's toolbar.\n
		  * It is a pure virtual method that needs to be implemented by all
        ...
        /** See whether this plugin can be detached (unloaded) or not.
          ...
          * uninstall or disable a plugin. Before disabling/uninstalling it, MC::Tools
    ...
    protected:
		/** Any descendent plugin should override this virtual method and
		  ...
		  * MC::Tools (PluginManager actually) when the plugin has been
		  * loaded and should attach in MC::Tools. When MC::Tools
		...
		/** Any descendent plugin should override this virtual method and
		  ...
		  * MC::Tools (PluginManager actually) when the plugin has been
		  * loaded, attached and should de-attach from MC::Tools.\n
    ...
    private:
		...
		/** Attach is <b>not</b> a virtual function, so you can't override it.
		  ...
		  * events from MC::Tools core library. Use OnAttach() for any
		...
		/** Release is <b>not</b> a virtual function, so you can't override it.
		  * The default implementation un-hooks the plugin from MC::Tools's
...
class PLUGIN_EXPORT cbDebuggerPlugin: public cbPlugin
{
	public:
		...
		virtual void StepByStep()  = 0;
};

/** @brief Base class for tool plugins
  *
  * This plugin is automatically managed by MC::Tools, so the inherited
...
/** @brief Base class for mime plugins
  *
  * Mime plugins are called by MC::Tools to operate on files that MC::Tools
...
/** @brief Base class for wizard plugins
  *
  * Wizard plugins are called by MC::Tools when the user selects
  * "File->New...".
  *
...
/** @brief Plugin registration object.
  *
  * Use this class to register your new plugin with MC::Tools.
