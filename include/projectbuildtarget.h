...
/** Represents a MC::Tools project build target. */
class DLLIMPORT ProjectBuildTarget : public BlockAllocated<ProjectBuildTarget, 1000>, public CompileTargetBase
{
	public:
        ...
        void SetGenerateEachLit(bool ch) { m_EachLit = ch;}
        bool GetGenerateEachLit() const { return m_EachLit ;}

        void SetAutoDetectFilesChange(bool ch) { m_AutoDetectFileChange = ch;}
        bool GetAutoDetectFilesChange() const { return m_AutoDetectFileChange;}

        void SetUseFlatObjects(bool ch) { m_UseFlatObjects = ch;}
        bool GetUseFlatObjects() const { return m_UseFlatObjects;}


        void SetUseFullSourcePaths(bool ch) { m_UseFullSourcePaths = ch;}
        bool GetUseFullSourcePaths() const {return m_UseFullSourcePaths ;}
        void MirrorCustomCurSettings();
        bool CompareMirror();
    private:
        struct MirrorCustomSettings
        {
            int AutoCheckFilesChange;
            int GeneraterEactLit;
            int UseFlatsObjects;
            int UseFullSourcePaths;
        };
        MirrorCustomSettings m_CMirror;
        bool m_Mirrored;
        ...
        bool m_EachLit;
        bool m_AutoDetectFileChange;
        bool m_UseFlatObjects;
        bool m_UseFullSourcePaths;
