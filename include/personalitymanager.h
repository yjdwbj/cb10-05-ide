...
/** @brief Manage different personalities.
  *
  * Personalities are different profiles of appearence for MC::Tools.
  ...
  * and no plugins would be loaded, making MC::Tools perfect for text editing
  ...
  * different file types launch MC::Tools using a different personality...
  *
  * To select the desired personality when launching MC::Tools, the user can
