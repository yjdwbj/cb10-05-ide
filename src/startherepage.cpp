 ...
 *
 * $Revision: 6261 $
 * $Id: startherepage.cpp 6261 2010-05-19 09:59:01Z mortenmacfly $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/src/startherepage.cpp $
 */
    ...
    m_pOwner(owner)
{
    ...
    if (f)
    {
        ...
        buf = _("<html><body><h1>Welcome to MC::Tools!</h1><br>The default start page seems to be missing...</body></html>");
    delete fs;
