 ...
 *
 * $Revision: 6104 $
 * $Id: scriptingsettingsdlg.cpp 6104 2010-01-23 12:56:12Z mortenmacfly $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/src/scriptingsettingsdlg.cpp $
 */
