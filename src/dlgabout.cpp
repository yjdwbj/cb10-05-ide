 ...
 *
 * $Revision: 6261 $
 * $Id: dlgabout.cpp 6261 2010-05-19 09:59:01Z mortenmacfly $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/src/dlgabout.cpp $
 */
...
//        "Chris Raschko       : Design of the 3D logo for MC::Tools\n"
...
//    XRCCTRL(*this, "txtLicense", wxTextCtrl)->SetValue(LICENSE_GPL);
    ...
    XRCCTRL(*this, "lblAuthor", wxStaticText)->SetLabel(_("The MC::Tools Team"));
